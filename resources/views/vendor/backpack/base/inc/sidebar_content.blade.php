...
<li class='nav-item'><a class='nav-link' href='#'><i class="nav-icon la la-first-info"></i>&nbsp; Bilan</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('sections') }}'><i class='nav-icon la la-address-book'></i> Sections</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('souscriptions') }}'><i class='nav-icon la la-question'></i> Souscriptions</a></li>
